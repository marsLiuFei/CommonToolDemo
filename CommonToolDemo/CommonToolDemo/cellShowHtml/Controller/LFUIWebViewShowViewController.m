...
@interface LFUIWebViewShowViewController ()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic, strong)UITableView *tableView;
@end

@implementation LFUIWebViewShowViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.view.backgroundColor = [UIColor whiteColor];
    self.navigationItem.title = @"UIWebView显示html";
    [self initTableView];
}
- (void )initTableView{
    ...
    [_tableView registerClass:[LFUIWebViewShowHtmlCell class] forCellReuseIdentifier:@"LFUIWebViewShowHtmlCell"];
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    return [LFUIWebViewShowHtmlCell cellHeight];
}
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    LFUIWebViewShowHtmlCell *cell = [tableView dequeueReusableCellWithIdentifier:@"LFUIWebViewShowHtmlCell"];
